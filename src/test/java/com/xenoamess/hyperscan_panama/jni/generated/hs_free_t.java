...
/** Compatibility facade for hs_free_t. */
public final class hs_free_t {
    ...
    public static MemorySegment allocate(hs_free_t.Function arg0, Arena arg1) {
        try {
            Class<?> platformFunc = Class.forName("com.xenoamess.hyperscan_panama.jni." + PLATFORM_FAMILY.replace('-', '_') + ".generated.hs_free_t$Function");
    ...
    public static void invoke(MemorySegment arg0, MemorySegment arg1) {
        try {
            find("invoke", void.class, MemorySegment.class, MemorySegment.class).invokeExact(arg0, arg1);
        } catch (Throwable e) {
            throw new RuntimeException(e);
        }
    }
