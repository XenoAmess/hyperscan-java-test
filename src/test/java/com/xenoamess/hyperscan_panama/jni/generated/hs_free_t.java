...
/** Optimized compatibility facade for hs_free_t. */
public final class hs_free_t {
    ...
    static {
        ...
        String className = "com.xenoamess.hyperscan_panama.jni." + PLATFORM_FAMILY.replace('-', '_') + ".generated.hs_free_t";
        try {
            DELEGATE = Class.forName(className);
            // no SYMBOL_LOOKUP/LIBRARY_ARENA in functional/struct classes
            PLATFORM_FUNCTION_CLASS = Class.forName("com.xenoamess.hyperscan_panama.jni." + PLATFORM_FAMILY.replace('-', '_') + ".generated.hs_free_t$Function");
            ...
            MH_INVOKE = findOrNull("invoke", void.class, MemorySegment.class, MemorySegment.class);
        } catch (Throwable e) {
            throw new RuntimeException("Failed to load platform-specific hs_free_t class: " + className, e);
        }
    }
    ...
    public static MemorySegment allocate(hs_free_t.Function arg0, Arena arg1) {
        try {
            MethodHandle mh = MethodHandles.lookup().findVirtual(Function.class, "apply", MethodType.methodType(void.class, MemorySegment.class)).bindTo(arg0);
    ...
    public static void invoke(MemorySegment arg0, MemorySegment arg1) {
        try {
            require("invoke", MH_INVOKE).invokeExact(arg0, arg1);
        } catch (Throwable e) {
            throw new RuntimeException(e);
        }
    }
